...
fig3c <- ggplot() +
  geom_ribbon(data = fig3c_data %>%
                filter(supply_source == "domestic"),
              aes(ymin = supply_min_percent, ymax = supply_max_percent, x = year), fill = "grey70") +
  geom_ribbon(data = fig3c_data %>%
                filter(supply_source == "foreign"),
              aes(ymin = supply_min_percent, ymax = supply_max_percent, x = year), fill = "grey70") +
